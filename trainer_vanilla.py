...
try:
    from .trainer_vanilla_base import *  # noqa: F403
    from .trainer_vanilla_base import LtxvTrainer as _BaseTrainer
    from .trainer_vanilla_base import TrainingStepOutput, logger
except ImportError:
    from trainer_vanilla_base import *  # type: ignore[no-redef]  # noqa: F403
    from trainer_vanilla_base import LtxvTrainer as _BaseTrainer
    from trainer_vanilla_base import TrainingStepOutput, logger
