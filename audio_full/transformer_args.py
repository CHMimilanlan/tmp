...
class TransformerArgsPreprocessor:
    ...
    def prepare(
        ...
        return TransformerArgs(
            ...
            # ===================================================
            track_xy=modality.track_xy,
            track_valid=modality.track_valid,
            # ===================================================
        )
...
class MultiModalTransformerArgsPreprocessor:
    def __init__(  # noqa: PLR0913
        ...
        # ===================================================
        self.is_count_video_ref = is_count_video_ref
        # ===================================================
    ...
    def prepare(
        ...
        if self.is_count_video_ref:
            token_num = modality.latent.shape[1]
            target_token_count = token_num // 5 * 4
            reference_token_count = token_num // 5
            return replace(
                transformer_args,
